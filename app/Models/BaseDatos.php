...
class BaseDatos extends Model
{
    ...
    public function getNegocio($cod_negocio){
        $activo = 1;
        $orden = "SELECT cod_negocio, nombre,  email, calle, ciudad, pais, telefono_negocio, fotos, foto_principal, coordenadas, sitio_web, cod_categoria  FROM negocio WHERE email=? AND activo=?";
