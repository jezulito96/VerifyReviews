...
<?php
        ...
        if(isset($imagenQr) && $imagenQr != false) echo "<h4 class='bien' style='padding-left:10px;'>Escanea el código Qr</h4><div class='qrcode-container' style='width: 60vw;margin:0px auto;'>" . $imagenQr ."</div>";
