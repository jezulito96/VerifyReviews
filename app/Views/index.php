...
<head>
    ...
    <?php echo "<script type='text/javascript' src='". base_url() . "jquery/jquery.js' integrity='sha256-eKhayi8LEQwp4NKxN+CfCh+3qOVUtJn3QNZ0TciWLP4=' crossorigin='anonymous'> </script>"; ?>
